 ...
 */
export interface Form1099KNestedFormFieldsOptionalSchema {
    /** The type of payer. Payment settlement entity (PSE) or Electronic Payment Facilitator (EPF)/Other third party. */
    payerClassification?: Abound.OneThousandNinetyNineKNestedFormFieldsOptionalSchemaPayerClassification;
    /** The type of transactions reported. */
    transactionsReportedClassification?: Abound.OneThousandNinetyNineKNestedFormFieldsOptionalSchemaTransactionsReportedClassification;
    ...
    grossAmountsByMonth?: Abound.OneThousandNinetyNineKNestedFormFieldsOptionalSchemaGrossAmountsByMonth;
}
