 ...
 */
export interface Form1099IntFormFieldsRequestSchema {
    /** Satisfying a requirement to report with respect to a U.S. account for chapter 4 purposes. */
    hasFatcaFilingRequirement?: boolean;
    /** The IRS “encourages” a payer to designate an account number for all Form 1099-INT filed. This field is required if payer has multiple accounts for a recipient for whom it is filing more than one Form 1099-INT. This field is also required if `fatca` is `true`. Abound will auto-generated this field if not provided. */
    ...
    /** An array that contains up to two state tax information objects. Abound currently only supports one state tax information object in this array. Abound does not currently support state-level tax withholding reporting on the 1099-INT, please contact us for more information. */
