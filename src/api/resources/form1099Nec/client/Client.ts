...
export class Form1099Nec {
    ...
    public async list(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling GET /v4/documents/1099-nec.");
            case "unknown":
                throw new errors.AboundError({
    ...
    public async create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling POST /v4/documents/1099-nec.");
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
                });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling POST /v4/documents/1099-nec/{documentId}/mail.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
    ...
    public async file(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling POST /v4/documents/1099-nec/{documentId}/file.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
    ...
    public async correct(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling POST /v4/documents/1099-nec/{documentId}/correct.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
    ...
    public async void(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling POST /v4/documents/1099-nec/{documentId}/void.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
    ...
    public async retrieve(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling GET /v4/documents/1099-nec/{documentId}.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
    ...
    public async delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling DELETE /v4/documents/1099-nec/{documentId}.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
