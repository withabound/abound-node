...
export class Form1099Nec {
     ...
     *
     * @param {Abound.Form1099NecRequestSchema} request
     * @param {Form1099Nec.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Abound.BadRequestError}
     * @throws {@link Abound.UnauthorizedError}
     ...
     * @param {Abound.Form1099NecMailRequest} request
     * @param {Form1099Nec.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Abound.BadRequestError}
     * @throws {@link Abound.UnauthorizedError}
     ...
     *
     * @param {string} documentId - The unique identifier for an existing document.
     * @param {Abound.Form1099NecCorrectRequestSchema} request
     * @param {Form1099Nec.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Abound.BadRequestError}
     * @throws {@link Abound.UnauthorizedError}
     ...
     */
    public async delete(documentId: string, requestOptions?: Form1099Nec.RequestOptions): Promise<Abound.OkSchema> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.AboundEnvironment.Production,
                `documents/1099-nec/${encodeURIComponent(documentId)}`
