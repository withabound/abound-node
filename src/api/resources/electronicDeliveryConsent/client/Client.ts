...
export declare namespace ElectronicDeliveryConsent {
    interface Options {
...
export class ElectronicDeliveryConsent {
    constructor(protected readonly _options: ElectronicDeliveryConsent.Options = {}) {}

    /**
     * Returns a list of Electronic Delivery Consents.
     *
     * @param {Abound.EDeliveryConsentListRequest} request
     * @param {ElectronicDeliveryConsent.RequestOptions} requestOptions - Request-specific configuration.
     *
