...
export class FormW8Ben {
    ...
    public async list(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling GET /v4/documents/w-8ben.");
            case "unknown":
                throw new errors.AboundError({
    ...
    public async create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling POST /v4/documents/w-8ben.");
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
                });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling GET /v4/documents/w-8ben/{documentId}.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
