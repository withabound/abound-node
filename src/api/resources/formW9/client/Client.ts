...
export class FormW9 {
    ...
    public async list(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling GET /v4/documents/w-9.");
            case "unknown":
                throw new errors.AboundError({
    ...
    public async create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError("Timeout exceeded when calling POST /v4/documents/w-9.");
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
                });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AboundTimeoutError(
                    "Timeout exceeded when calling GET /v4/documents/w-9/{documentId}.",
                );
            case "unknown":
                throw new errors.AboundError({
                    message: _response.error.errorMessage,
