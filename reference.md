...
<details><summary><code>client.electronicDeliveryConsent.<a href="/src/api/resources/electronicDeliveryConsent/client/Client.ts">list</a>({ ...params }) -> Abound.EDeliveryConsentSchema[]</code></summary>
<dl>
<dd>
...
```typescript
await client.electronicDeliveryConsent.list();
```
...
**requestOptions:** `ElectronicDeliveryConsent.RequestOptions`
