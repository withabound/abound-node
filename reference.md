...
<details><summary><code>client.w8BenE.<a href="/src/api/resources/w8BenE/client/Client.ts">getW8BenE</a>(documentId) -> AboundApi.W8BenESchema</code></summary>
<dl>
<dd>
...
```typescript
await client.w8BenE.getW8BenE("{{documentId}}");
```
